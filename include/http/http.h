#ifndef __AZURE_HTTP_H__
#define __AZURE_HTTP_H__
...
public:
    ...
    template<typename T>
    bool checkGetHeaderAs(const std::string &key, T &val, const T &def = T()) {     // def: default
    ...
    template<typename T>
    bool checkGetParamAs(const std::string &key, T &val, const T &def = T()) {     // def: default
        return checkGetAs(m_headers, key, val, def);
    }
    ...
    template<typename T>
    bool checkGetCookieAs(const std::string &key, T &val, const T &def = T()) {     // def: default
        return checkGetAs(m_headers, key, val, def);
    }
