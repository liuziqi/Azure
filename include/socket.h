#ifndef __AZURE_SOCKET_H__
#define __AZURE_SOCKET_H__
...
class Socket : public std::enable_shared_from_this<Socket>, public Noncpoyable {
public:
    ...
    static Socket::ptr CreateTCP(azure::Address::ptr address);
    static Socket::ptr CreateUDP(azure::Address::ptr address);
    ...
    int recv(iovec *buffers, size_t length, int flags=0);   // length指iovec的个数
