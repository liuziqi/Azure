#ifndef __AZURE_ADDRESS_H__
#define __AZURE_ADDRESS_H__
...
public:
    ...
    static bool GetInterfaceAddress(std::multimap<std::string, std::pair<Address::ptr, uint16_t>> &result, int family=AF_UNSPEC);
    static bool GetInterfaceAddress(std::vector<std::pair<Address::ptr, uint16_t>> &result, const std::string &iface, int family=AF_UNSPEC);
